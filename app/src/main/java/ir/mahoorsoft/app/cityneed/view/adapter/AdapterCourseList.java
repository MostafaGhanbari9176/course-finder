...
public class AdapterCourseList extends RecyclerView.Adapter<AdapterCourseList.Holder> {
    ...
    private ArrayList<Items> surce = new ArrayList<>();
    String directoryName;

    public AdapterCourseList(Context context, ArrayList<Items> surce, OnClickItemCourseList onClickItemCourseList, String directoryName) {
