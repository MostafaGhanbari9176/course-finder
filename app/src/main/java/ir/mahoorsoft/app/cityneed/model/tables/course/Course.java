...
public class Course {
    ...
    public void addtCource(String teacherId, String subject, int tabagheId, int type, int capacity, int mony, String sharayet, String tozihat, String startDate, String endDate, String day, String hours, String oldRange) {
        Api api = ApiClient.getClient().create(Api.class);
        Call<ArrayList<Response>> addCourse = api.addCourse(teacherId, subject, tabagheId, type, capacity, mony, sharayet, tozihat, startDate, endDate, day, hours, oldRange);
        addCourse.enqueue(new Callback<ArrayList<Response>>() {
            @Override
