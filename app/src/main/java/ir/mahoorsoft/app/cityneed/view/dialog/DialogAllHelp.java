...
public class DialogAllHelp implements View.OnClickListener {
    ...
    private void setText(){
        ...
        views.get(1).setText("برای ثبت نام در یک دوره کافیه بروی دوره مورد نظر کلیک کرده و پس از نمایش مشخصات دوره در انتهای مشخصات بروی کلید ثبت نام کلیک کنید");
        ...
        views.get(4).setText("برای مدیریت محصلین و همچنین دوره هایی که ثبت کرده اید کافیه در صفحه پروفایل بروی کلید اضافه شده کلیک کرده تا لیست دوره های ثبت شده توسط خودرا ملاحظه کنید با کلیک بروی هر دوره می توانید لیست محصلین را مشاهده کرده دوره را ویرایش کرده و یک ویدیو مرتبط با دوره بارگزاری کنید.");
    }
